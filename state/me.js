...
globalThis.newguild=function(){me.guilds.push(new Guild({
	...
	channels: [new Channel({id:'/general', messages: [new Message({
		content: 'This guild is \'client-only\': Your friends cannot join this guild and it does not exist anywhere except on your device. It will be deleted once you close chit',
